...
def main():
    ...
    parser.add_argument('pdb', metavar='<PDB path>', type=str,
                        help='input PDB file')
    parser.add_argument('-a', metavar='<sequence id>', type=str,
                        default=None,
    ...
    print("Extracted amino acid sequence '{}' from FASTA file '{}'."
          .format(fasta_seq.id, args.fasta))
    print("If you would like to specify a different sequence in the FASTA file,"
          " please run `make_map.py -h` for help.\n")
