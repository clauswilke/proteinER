...
def main():
	...
	'''
	#creating a parser
	parser = argparse.ArgumentParser(description='Translate amino acid sequences into nucleotide sequences while maintaining the amino acid alignment and the order of sequences.')
	#adding arguments 
