...
{
    _cachingOK = 0;
    ExecuteAFile (Join(DIRECTORY_SEPARATOR,{{PATH_TO_CURRENT_BF[0][Abs(PATH_TO_CURRENT_BF)-2],"FUBAR_HBL_sjs","FUBAR_PHASE_1.bf"}}), {"0" : _fubarNucFitLocation});
...
else
{
    ...
    if (_isDSVariable == 0) {
        ...
        ExecuteAFile (Join(DIRECTORY_SEPARATOR,{{PATH_TO_CURRENT_BF[0][Abs(PATH_TO_CURRENT_BF)-2],"FUBAR_HBL_sjs","FUBAR_PHASE_2.bf"}}), {"0" : _fubarNucFitLocation,
...
else
{
    ...
    ExecuteAFile (Join(DIRECTORY_SEPARATOR,{{PATH_TO_CURRENT_BF[0][Abs(PATH_TO_CURRENT_BF)-2],"FUBAR_HBL_sjs","FUBAR_PHASE_3.bf"}}), {"0" : _fubarMCMCSamplesLocation,
...
else
{
    ...
    ExecuteAFile (Join(DIRECTORY_SEPARATOR,{{PATH_TO_CURRENT_BF[0][Abs(PATH_TO_CURRENT_BF)-2],"FUBAR_HBL_sjs","FUBAR_PHASE_4.bf"}}), {"0" : _fubarNucFitLocation,
                                                                                                                                 "1" : _fubarGridInfoLocation,
...
ExecuteAFile (Join(DIRECTORY_SEPARATOR,{{PATH_TO_CURRENT_BF[0][Abs(PATH_TO_CURRENT_BF)-2],"FUBAR_HBL_sjs","FUBAR_tools.ibf"}}));
