ExecuteAFile ("qndhelper1_sjs.ibf");
...
#include "qndhelper2_sjs.ibf";

fprintf (stdout, "\n\nPhase 4: Ancestral State Reconstruction and Counting\n\n");

pooledFreqs = overallFrequencies;
/*
pooledFreqs = {4,1};
